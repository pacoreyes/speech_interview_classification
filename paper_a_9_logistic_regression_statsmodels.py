# -----------------------------------------------------------
# Logistic regression model for the classification of interviews and speeches
# based on linguistic features, and using statsmodels
#
# (C) 2021-2024 Juan-Francisco Reyes, Cottbus, Germany
# Brandenburg University of Technology, Germany.
# Released under MIT License
# email pacoreye@protonmail.com
# -----------------------------------------------------------
